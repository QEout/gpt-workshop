...
const BuilderPage = () => {
  ...
  const {
    ...
    loading,
    refresh,
  } = useRequest(assistantService.listAssistants);
  const router = useRouter();
  return (
    <div className="py-8 font-sans h-screen w-screen overflow-y-auto">
      <div className="p-2 text-center space-y-2">
        <h1 className="text-2xl">BuilderPage</h1>
        <p>
          This is a page that uses the assistantService to get a list of
          helpers.
        </p>
      </div>
            ...
            <div
              ...
              <div className="flex justify-between items-end">
                ...
                <span className="text-gray-400 text-sm">
                  {format(item.created_at * 1000, 'yy-MM-dd HH:mm')}
                </span>
              </div>
            </div>
          );
